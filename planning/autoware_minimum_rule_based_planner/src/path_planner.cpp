  ...
  const builtin_interfaces::msg::Time & stamp)
{
  ...
  const auto [s_start, s_end] = [&]() {
    ...
    // Deviation is judged at the footprint center, the same reference as update_current_lanelet;
    // base_link sits outside the current lanelet near lanelet transitions and would stop the path.
